...
const SEO: React.FC<SEOProps> = ({
  ...
  description = "Join the transformative 7-day Spark Writers' Retreat in the Himalayas (May 24-30, 2026). Expert mentorship, luxury villa accommodation, free ISBN, publishing guidance.",
