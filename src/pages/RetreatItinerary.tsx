        ...
        <div className="timeline-wrapper">
          ...
          <div className="timeline-left stagger-list">
            <div className="timeline-left-item">
              ...
              <p className="timeline-left-text">Friday, 24 May 2026 — Settle into your luxurious villa, meet fellow writers, and embrace the mountain serenity</p>
          ...
          <div className="timeline-right stagger-list">
            <div className="timeline-right-item">
              ...
              <p className="timeline-left-text">Thursday, 30 May 2026 — Leave transformed, inspired, and equipped with tools to continue your writing journey</p>
            </div>
